...
public class AddCardToStripeController {
    public void addCardToStripe(final Context context, String cus_id, final String token, final ParseControlListner lister) {

        String url = "https://api.stripe.com/v1/customers/" + cus_id + "/sources";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.equals(null)) {
                    ...
                    lister.onSuccess(response,"add_card_stripe");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                lister.onError(error,"add_card_stripe");
            }
        }) {
